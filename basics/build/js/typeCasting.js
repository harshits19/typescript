...
let abc = "hello";
let bcc = abc; //less specific - converting a string type into string or number type
let ccc = abc; //more specific - converting string into a "hello" literal
let ddd = "world"; //here ddd has type One which is string, same as let ddd = "world" as One
...
const imgT = document.querySelector("#myID"); //this solves the above problem as now TS specifically identifies it as image element
